...
@GameTestHolder(SpaceLogger.MOD_ID)
...
public class SpaceLoggerGameTests {
    ...
    public void recordsHurtAndKill(GameTestHelper helper) {
        ...
        zombie.hurt(player.damageSources().playerAttack(player), 100.0F);
    ...
    public void recordsBreakPlaceUse(GameTestHelper helper) {
        ...
        player.setPos(absPlacePos.getX() - 1.5D, absPlacePos.getY() + 1.0D, absPlacePos.getZ() + 0.5D);
        ...
        helper.setBlock(usePos, Blocks.LEVER.defaultBlockState());
    ...
    public void recordsAddAndRemoveItem(GameTestHelper helper) {
        ...
        chest.setItem(1, new ItemStack(Items.COBBLESTONE, 3));
        ...
        AbstractContainerMenu menu = ChestMenu.threeRows(1, player.getInventory(), chest);
        ...
        menu.clicked(playerHotbar0, 0, ClickType.PICKUP, player);
        menu.clicked(chestSlot0, 0, ClickType.PICKUP, player);
        ...
        menu.clicked(chestSlot1, 0, ClickType.PICKUP, player);
        menu.clicked(playerHotbar1, 0, ClickType.PICKUP, player);
    ...
    public void recordsChainTntBreakForIgnitingPlayer(GameTestHelper helper) {
        ...
        BlockPos targetStonePos = new BlockPos(6, 2, 1);
    ...
    public void recordsEndCrystalPlacementAsPlaceNotUse(GameTestHelper helper) {
        ...
        player.setPos(absBasePos.getX() - 2.0D, absBasePos.getY() + 1.0D, absBasePos.getZ() + 0.5D);
        BlockHitResult placeHit = new BlockHitResult(
    ...
    public void recordsEndCrystalExplosionBreakAndKillForAttackingPlayer(GameTestHelper helper) {
        ...
        player.setPos(absCrystalBasePos.getX() - 2.0D, absCrystalBasePos.getY() + 1.0D, absCrystalBasePos.getZ() + 0.5D);
        BlockHitResult placeHit = new BlockHitResult(
